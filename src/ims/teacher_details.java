...
class teacher_details implements ActionListener {
    ...
    teacher_details() {
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("ims/icons/teacher details.jpg"));
        id15.setIcon(img);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b) {
            try {
                ...
                String q = "insert into employee values('" + a + "','" + bb + "','" + c + "','" + d + "','" + e + "','" + ff + "','" + g + "','" + h + "','"+i+"')";
