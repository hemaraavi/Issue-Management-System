...
class student_details implements ActionListener{
    ...
    public student_details(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("ims/icons/employee.jpeg"));
        ...
        id10= new JLabel("ID NO");
        id10.setBounds(100,80,130,30);
        id10.setFont(new Font("serif",Font.BOLD,20));
        id15.add(id10);
         
        t10=new JTextField();
        t10.setBounds(180,80,150,30);
        id15.add(t10);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                ...
                String q = "insert into student values('"+j+"','"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+k+"','"+l+"','"+m+"')";
